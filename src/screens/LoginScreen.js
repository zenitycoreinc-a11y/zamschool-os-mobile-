  ...
  return (
    <SafeAreaView style={styles.safe} edges={['top', 'bottom']}>
      ...
      >
        ...
        >
          <LinearGradient
            colors={[colors.heroBackdropStart, colors.heroBackdropMid, colors.heroBackdropEnd]}
            style={styles.hero}
          >
          ...
          <View style={styles.loginPanel}>
            ...
            <View style={styles.fieldGroup}>
              ...
              <View style={[styles.inputWrap, errors.email ? styles.inputError : null]}>
                <Feather name="mail" size={18} color={errors.email ? colors.danger : colors.mutedSoft} />
                <TextInput
                  style={styles.input}
            ...
            <View style={styles.fieldGroup}>
              ...
              <View style={[styles.inputWrap, errors.password ? styles.inputError : null]}>
                <Feather name="lock" size={18} color={errors.password ? colors.danger : colors.mutedSoft} />
                <TextInput
                  ref={passwordRef}
                  style={styles.input}
                ...
                <Pressable onPress={() => setShowPassword((current) => !current)} hitSlop={8}>
                  <Feather name={showPassword ? 'eye-off' : 'eye'} size={18} color={colors.mutedSoft} />
                </Pressable>
              </View>
